...
def main(J, J13, Jinter, hz, hx, L, model="linear"):
    ...
    with h5py.File(f"non-interacting/datos/data_psi_linear-L_{L}_Jint_0.00_hz_0.01_hx0.01.h5", "r") as f:
    ...
    with h5py.File(f"lineal/datos/data_{fname}.h5", "w") as f:
        hdf5_io.save_to_hdf5(f, data)

    data = {"psi": psi}
    with h5py.File(f"lineal/datos/data_psi_{fname}.h5", "w") as f:
        hdf5_io.save_to_hdf5(f, data)
